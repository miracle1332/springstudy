...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <security:authorize access="isAuthenticated()"><!-- 로그아웃은 포스트방식으로 해야함ㅁㅁ!!!! -->
         <ul class="nav navbar-nav navbar-right">
	            ...
	            <c:if test="${mvo.member.memProfile eq null}">
			      <li><img class="img-circle" src="${contextPath}/resources/images/default.jpg" style="width: 50px; height: 50px"/>
			    </c:if>
			    <c:if test="${mvo.member.memProfile ne null}">
			      <li><img class="img-circle" src="${contextPath}/resources/proimg/${mvo.member.memProfile}" style="width: 50px; height: 50px"/>
			    </c:if>
