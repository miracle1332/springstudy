...
<div class="container">
 <jsp:include page="../common/header.jsp"/>
  ...
  <div class="panel panel-default">
    		...
    		<table class="table table-bordered" style="text-align: center; border: 1px solid #dddd;">
    		  ...
    		  <tr>
    		   ...
    		   <tr>
    		  	...
    		  	<td colspan="2"><input type="text" id="memEmail" name="memEmail" class="form-control" maxlength="50" placeholder="이메일 주소를 입력하세요."/></td>
    		  </tr>
    		  <!-- 권한 체크박스 추가 -->
    		   <tr>
    ...
    <!-- 다이얼로그창=모달창 -->
	    <!-- Modal -->
	<div id="myModal" class="modal fade" role="dialog">0
